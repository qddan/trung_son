                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              image: AssetImage('assets/chair/chris.jpg'))),
                    ),
                    SizedBox(width: 10.0),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                ...
                Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: <Widget>[
                        cardDetails(
                            'Pending payment', 'assets/chair/card.png', '5'),
                        cardDetails(
                            'To be shipped', 'assets/chair/box.png', '2'),
                      ],
                    ),
                    SizedBox(height: 10.0),
                    Row(
                      ...
                      children: <Widget>[
                        cardDetails(
                            'To be received', 'assets/chair/trucks.png', '8'),
                        cardDetails('Return / Replace',
                            'assets/chair/returnbox.png', '0'),
                      ],
                    ),
                    SizedBox(height: 5.0)
                  ],
